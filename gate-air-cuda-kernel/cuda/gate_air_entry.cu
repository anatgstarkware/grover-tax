...
// Resident-only entry: all trace columns are live on device. The Rust mirror
// (grover-tax-v02 gate-air-cuda-kernel/src/lib.rs) MUST declare this exact arg list —
// a mismatch is UB.
